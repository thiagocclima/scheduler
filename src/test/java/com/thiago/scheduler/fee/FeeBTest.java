...
public class FeeBTest {
	...
	public void shouldCalculateFeeEqualToo9() {
		FeeB feeB = new FeeB();
		BigDecimal feeToPay = feeB.calculate(new BigDecimal(100));
	...
	public void shouldNotCalculateForNullAmount() {
		FeeB feeB = new FeeB();
		Assertions.assertThrows(IllegalArgumentException.class, () -> feeB.calculate(null));
	}
	...
	void shouldNotCalculateForNegativeAmount() {
		...
		Assertions.assertThrows(IllegalArgumentException.class, () -> feeB.calculate(amount));
	}
	...
	void shouldCalculateForDecimalAmount() {
		...
		BigDecimal actual = feeB.calculate(amount);
